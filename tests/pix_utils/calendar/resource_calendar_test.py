...
def test_absolute_unavailability_intervals_within():
    ...
    assert absolute_unavailability_intervals_within(
        start=pd.Timestamp("2023-01-11T06:10:46"),
        end=pd.Timestamp("2023-01-11T21:35:11"),
        schedule=working_calendar
    ) == [
               Interval(pd.Timestamp("2023-01-11T12:00:00"), pd.Timestamp("2023-01-11T14:00:00")),
               Interval(pd.Timestamp("2023-01-11T18:00:00"), pd.Timestamp("2023-01-11T20:00:00")),
           ]
    # Non-working periods withing the weekend is all the search interval
    assert absolute_unavailability_intervals_within(
        start=pd.Timestamp("2023-01-06T23:10:46"),
    ...
    assert absolute_unavailability_intervals_within(
        ...
        end=pd.Timestamp("2023-02-15T21:35:11"),
        schedule=working_calendar
    ) == [
               # Monday
               Interval(pd.Timestamp("2023-02-06T03:10:46"), pd.Timestamp("2023-02-06T05:00:00")),
               Interval(pd.Timestamp("2023-02-06T12:00:00"), pd.Timestamp("2023-02-06T14:00:00")),
               Interval(pd.Timestamp("2023-02-06T18:00:00"), pd.Timestamp("2023-02-06T20:00:00")),
               Interval(pd.Timestamp("2023-02-06T22:00:00"), pd.Timestamp("2023-02-06T23:59:59.999999")),
               # Tuesday
               Interval(pd.Timestamp("2023-02-07T00:00:00"), pd.Timestamp("2023-02-07T05:00:00")),
               Interval(pd.Timestamp("2023-02-07T12:00:00"), pd.Timestamp("2023-02-07T14:00:00")),
               Interval(pd.Timestamp("2023-02-07T18:00:00"), pd.Timestamp("2023-02-07T20:00:00")),
               Interval(pd.Timestamp("2023-02-07T22:00:00"), pd.Timestamp("2023-02-07T23:59:59.999999")),
               # Wednesday
               Interval(pd.Timestamp("2023-02-08T00:00:00"), pd.Timestamp("2023-02-08T05:00:00")),
               Interval(pd.Timestamp("2023-02-08T12:00:00"), pd.Timestamp("2023-02-08T14:00:00")),
               Interval(pd.Timestamp("2023-02-08T18:00:00"), pd.Timestamp("2023-02-08T20:00:00")),
               Interval(pd.Timestamp("2023-02-08T22:00:00"), pd.Timestamp("2023-02-08T23:59:59.999999")),
               # Thursday
               Interval(pd.Timestamp("2023-02-09T00:00:00"), pd.Timestamp("2023-02-09T05:00:00")),
               Interval(pd.Timestamp("2023-02-09T12:00:00"), pd.Timestamp("2023-02-09T14:00:00")),
               Interval(pd.Timestamp("2023-02-09T18:00:00"), pd.Timestamp("2023-02-09T20:00:00")),
               Interval(pd.Timestamp("2023-02-09T22:00:00"), pd.Timestamp("2023-02-09T23:59:59.999999")),
               # Friday
               Interval(pd.Timestamp("2023-02-10T00:00:00"), pd.Timestamp("2023-02-10T05:00:00")),
               Interval(pd.Timestamp("2023-02-10T12:00:00"), pd.Timestamp("2023-02-10T14:00:00")),
               Interval(pd.Timestamp("2023-02-10T18:00:00"), pd.Timestamp("2023-02-10T20:00:00")),
               Interval(pd.Timestamp("2023-02-10T22:00:00"), pd.Timestamp("2023-02-10T23:59:59.999999")),
               # Saturday
               Interval(pd.Timestamp("2023-02-11T00:00:00"), pd.Timestamp("2023-02-11T23:59:59.999999")),
               # Sunday
               Interval(pd.Timestamp("2023-02-12T00:00:00"), pd.Timestamp("2023-02-12T23:59:59.999999")),
               # Monday
               Interval(pd.Timestamp("2023-02-13T00:00:00"), pd.Timestamp("2023-02-13T05:00:00")),
               Interval(pd.Timestamp("2023-02-13T12:00:00"), pd.Timestamp("2023-02-13T14:00:00")),
               Interval(pd.Timestamp("2023-02-13T18:00:00"), pd.Timestamp("2023-02-13T20:00:00")),
               Interval(pd.Timestamp("2023-02-13T22:00:00"), pd.Timestamp("2023-02-13T23:59:59.999999")),
               # Tuesday
               Interval(pd.Timestamp("2023-02-14T00:00:00"), pd.Timestamp("2023-02-14T05:00:00")),
               Interval(pd.Timestamp("2023-02-14T12:00:00"), pd.Timestamp("2023-02-14T14:00:00")),
               Interval(pd.Timestamp("2023-02-14T18:00:00"), pd.Timestamp("2023-02-14T20:00:00")),
               Interval(pd.Timestamp("2023-02-14T22:00:00"), pd.Timestamp("2023-02-14T23:59:59.999999")),
               # Wednesday
               Interval(pd.Timestamp("2023-02-15T00:00:00"), pd.Timestamp("2023-02-15T05:00:00")),
               Interval(pd.Timestamp("2023-02-15T12:00:00"), pd.Timestamp("2023-02-15T14:00:00")),
               Interval(pd.Timestamp("2023-02-15T18:00:00"), pd.Timestamp("2023-02-15T20:00:00"))
           ]
